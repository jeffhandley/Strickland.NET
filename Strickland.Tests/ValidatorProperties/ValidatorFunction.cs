...
namespace Strickland.Tests.ValidatorProperties
{
    public class ValidatorFunction
    {
        ...
        public bool Returning_Bool_And_Properties_HasIsValid(int testValue)
        {
            var props = new { Message = "Speed must be at least 88mph" };
            var timeTravel = (int value) => (value >= 88, props);
            var result = Validation.Validate(testValue, timeTravel);
        ...
        public int Returning_Bool_And_Properties_HasValue(int testValue)
        {
            var props = new { Message = "Speed must be at least 88mph" };
            var timeTravel = (int value) => (value >= 88, props);
            var result = Validation.Validate(testValue, timeTravel);
        ...
        [TestCase(88)]
        [TestCase(90)]
        public void Returning_Bool_And_Properties_HasProperties(int testValue)
        {
            var props = new { Message = "Speed must be at least 88mph" };
            var timeTravel = (int value) => (value >= 88, props);
            var result = Validation.Validate(testValue, timeTravel);
        ...
        public string Validator_With_IsValid_And_TypedProperties_Functions(int testValue)
        {
        ...
        [TestCase(88, ExpectedResult = "Your speed of 88mph was enough to travel through time!")]
        [TestCase(90, ExpectedResult = "Your speed of 90mph was enough to travel through time!")]
        public string Validator_From_IsValid_And_AnonymousProperties_Functions(int testValue)
        {
